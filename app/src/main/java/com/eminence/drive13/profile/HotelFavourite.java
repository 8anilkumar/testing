...
public class HotelFavourite extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_hotelfavourites);
    ...
    public void submit() {
        ...
        requestQueue = Volley.newRequestQueue(HotelFavourite.this);
        ...
        JsonObjectRequest stringRequest = new JsonObjectRequest(Request.Method.POST, url, parameters, new Response.Listener<JSONObject>() {
            ...
            public void onResponse(JSONObject response) {
                ...
                try {
                    ...
                    if (r_code.equalsIgnoreCase("1")) {
                        ...
                        ServiceAdapter cateAdapter = new ServiceAdapter(arrayList, HotelFavourite.this,"Hotel");
                        recycler.setLayoutManager(new LinearLayoutManager(HotelFavourite.this, LinearLayoutManager.VERTICAL, false));
                    ...
                    e.printStackTrace();
                    Toast.makeText(HotelFavourite.this, "" + e, Toast.LENGTH_SHORT).show();
            ...
            public void onErrorResponse(VolleyError error) {
                ...
                Toast.makeText(HotelFavourite.this, "" + error, Toast.LENGTH_SHORT).show();
