...
import com.eminence.drive13.WorkshopMain;
...
public class Workshopfav extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_workshopfav);
    ...
    public void insurencefav(View view) {
        startActivity(new Intent(getApplicationContext(), Insuarencefav.class));
        overridePendingTransition(0, 0);
        finish();
    }
    ...
    public void submit() {
        ...
        requestQueue = Volley.newRequestQueue(Workshopfav.this);

        Map<String, String> params = new HashMap();
        params.put("category", "Workshop");
        ...
        JsonObjectRequest stringRequest = new JsonObjectRequest(Request.Method.POST, url, parameters, new Response.Listener<JSONObject>() {
            ...
            public void onResponse(JSONObject response) {
                ...
                try {
                    ...
                    if (r_code.equalsIgnoreCase("1")) {
                        ...
                        ServiceAdapter cateAdapter = new ServiceAdapter(arrayList, Workshopfav.this,"Workshop");
                        recycler.setLayoutManager(new LinearLayoutManager(Workshopfav.this, LinearLayoutManager.VERTICAL, false));
                    ...
                    e.printStackTrace();
                    Toast.makeText(Workshopfav.this, "" + e, Toast.LENGTH_SHORT).show();
            ...
            public void onErrorResponse(VolleyError error) {
                ...
                Toast.makeText(Workshopfav.this, "" + error, Toast.LENGTH_SHORT).show();
