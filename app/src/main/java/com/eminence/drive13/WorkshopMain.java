...
import com.eminence.drive13.profile.Workshopfav;
...
public class WorkshopMain extends AppCompatActivity {
    ...
    private void searchfun() {
        ...
        requestQueue = Volley.newRequestQueue(WorkshopMain.this);
        ...
        JsonObjectRequest stringRequest = new JsonObjectRequest(Request.Method.POST, url, parameters, new Response.Listener<JSONObject>() {
            ...
            public void onResponse(JSONObject response) {
                ...
                try {
                    ...
                    if (r_code.equalsIgnoreCase("1")) {
                        ...
                        ServiceAdapter cateAdapter = new ServiceAdapter(arrayList, WorkshopMain.this,"Workshop");
                        recycler.setLayoutManager(new LinearLayoutManager(WorkshopMain.this, LinearLayoutManager.VERTICAL, false));
                    ...
                    e.printStackTrace();
                    Toast.makeText(WorkshopMain.this, "" + e, Toast.LENGTH_SHORT).show();
            ...
            public void onErrorResponse(VolleyError error) {
                ...
                Toast.makeText(WorkshopMain.this, "" + error, Toast.LENGTH_SHORT).show();
    ...
    public void submit() {
        ...
        SharedPreferences sharedPreferences = PreferenceManager.getDefaultSharedPreferences(WorkshopMain.this);
